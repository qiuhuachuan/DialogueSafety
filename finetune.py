...
def main():
    ...
    weight = torch.tensor([2.0, 2.0, 0.5, 2.0, 2.0, 2.0, 2.0, 0.5]).cuda()
    ...
    for epoch in range(0, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            outputs = model(**batch, weight=weight)
            loss = outputs.loss
        ...
        average_eval_loss = test_loss / len(test_dataset)
